...
export default function PageAnalysisPanel({
  ...
  return (
    <div
      className="w-full bg-gray-800/92 rounded flex flex-col text-foreground border border-zinc-700/30"
      style={{ height: `${height}px` }}
    >
      {/* Scrollable Container for both header and content */}
      <div className="flex-1 overflow-x-auto overflow-y-auto [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-zinc-800/40 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-thumb]:bg-zinc-400 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-zinc-300">
        <div className="min-w-[800px]">
          {/* Sticky Header */}
          <div className="sticky top-0 z-10 border-b border-zinc-700/40 bg-zinc-900 backdrop-blur-sm">
            <div className="flex h-12 text-foreground px-4 items-center gap-4">
              {/* ICON */}
              <div
